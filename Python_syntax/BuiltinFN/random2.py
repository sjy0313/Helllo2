...
def random_pop(data):
    number = random.randint(0, len(data)-1) # index 순서로 인식
    return data.pop(number)

if __name__ == "__main__": #  해당 구문이 사용된 파이썬 파일을 직접 실행했을 때만
# __name__ :모듈의 이름을 담고 있는 파이썬 내장 변수
#아래 코드를 실행하겠다 라는 의미입니다.
    data = [1, 2, 3, 4, 5]
    while data:
